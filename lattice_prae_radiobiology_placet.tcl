...
Girder
Quadrupole -name "Q_DOUBLET_1ST_1" -synrad $quad_synrad -length 0.2 -strength [expr 1.372984117*$e0] -e0 $e0 
Girder
Drift -name "D_DOUBLET_1ST_1" -length 0.5 
Girder
Quadrupole -name "Q_DOUBLET_1ST_2" -synrad $quad_synrad -length 0.2 -strength [expr -1.046464876*$e0] -e0 $e0 
Girder
...
Girder
Quadrupole -name "Q_TRIPLET_3RD_1" -synrad $quad_synrad -length 0.2 -strength [expr 1.372893263*$e0] -e0 $e0 
Girder
Drift -name "D_TRIPLET_3RD_1" -length 0.2 
Girder
Quadrupole -name "Q_TRIPLET_3RD_2" -synrad $quad_synrad -length 0.2 -strength [expr -1.653821791*$e0] -e0 $e0 
Girder
Drift -name "D_TRIPLET_3RD_2" -length 0.2 
Girder
Quadrupole -name "Q_TRIPLET_3RD_3" -synrad $quad_synrad -length 0.2 -strength [expr 0.7721261379*$e0] -e0 $e0 
Girder
